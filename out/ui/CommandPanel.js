...
class CommandPanel {
    ...
    static show(context, timeLogger) {
        ...
        const panel = vscode.window.createWebviewPanel(CommandPanel.viewType, 'Jira Time Tracker', column || vscode.ViewColumn.One, {
            enableScripts: true,
...
CommandPanel.viewType = 'jiraTimeTracker.commandPanel';
