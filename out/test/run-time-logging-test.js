...
const complete_time_logging_test_1 = require("./complete-time-logging.test");
async function main() {
    console.log('🚀 Starting Complete Time Logging Test');
    console.log('=====================================\n');
    const service = new complete_time_logging_test_1.CompletTimeLoggingService();
...
//# sourceMappingURL=run-time-logging-test.js.map