...
exports.JiraBranchDiscovery = void 0;
...
class JiraBranchDiscovery {
     ...
     */
    async searchTicketsWithBranches(branchName) {
        try {
            ...
            const response = await axios_1.default.get(`${config.baseUrl}${searchUrl}`, {
                auth: {
     ...
     */
    async searchRecentTicketsForBranch(branchName) {
        try {
            const config = (0, settings_1.getJiraConfig)();
     ...
     */
    async checkTicketDevelopmentInfo(issue, branchName) {
     ...
     */
    async searchByProjectAndPattern(branchName) {
        try {
     ...
     */
    extractTicketInfo(issue, branchName) {
        return {
            ticketId: issue.key,
     ...
     */
    async verifyAndEnhanceTicket(ticketInfo) {
        try {
...
exports.JiraBranchDiscovery = JiraBranchDiscovery;
...
//# sourceMappingURL=jira-branch-discovery.js.map