...
function activate(context) {
    try {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.show-productive-logs', async () => {
            try {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.test-output-channel', async () => {
            try {
                const { testOutputChannel } = await Promise.resolve().then(() => require('./test/output-channel-test'));
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.test-error-logging', async () => {
            try {
                const { testErrorLogging } = await Promise.resolve().then(() => require('./test/output-channel-test'));
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.check-productive-credentials', async () => {
            try {
                outputChannel.show(true);
                ...
                const settingsApiToken = config.get('productive.apiToken');
                const settingsOrgId = config.get('productive.organizationId');
                ...
                const jiraService = timeLogger.jiraService;
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debug-commit', async () => {
            try {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debug-git-state', async () => {
            try {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debug-trigger-commit', async () => {
            try {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.test-extension', () => {
        ...
        // Debug commands
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debugTriggerCommit', async () => {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debugTriggerHeadChange', async () => {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debugGitStatus', async () => {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('jira-time-tracker.debugPeriodicCheck', async () => {
